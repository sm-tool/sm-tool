package pl.smt.shared.error.domain;
 ...
 *
 * <p>It is designed to validate domain input, if you want to validate application input it's better
 * to stick to BeanValidation to get all errors at once and internationalized error messages.
 *
 * <p>The main goal of this class is to ensure some basic type validation in your classes. If you
 * have to do business related validation you should create your own exception and code dedicated to
 * that check
 */
public final class Assert {
   ...
   */
  public static <T> CollectionAsserter<T> field(
    String field,
    Collection<T> input
  ) {
  ...
  public static final class StringAsserter {
     ...
     * @return The current asserter
     * @throws MissingMandatoryValueException if the expected length is strictly positive and the
     *     value is null
    ...
    public StringAsserter minLength(int length) {
      ...
      if (value.length() < length) {
        throw StringTooShortException.builder()
          .field(field)
          .value(value)
          .minLength(length)
          .build();
    ...
    public StringAsserter maxLength(int length) {
      ...
      if (value.length() > length) {
        throw StringTooLongException.builder()
          .field(field)
          .value(value)
          .maxLength(length)
          .build();
  ...
  public static final class CollectionAsserter<T> {
     ...
     * @return The current asserter
     * @throws MissingMandatoryValueException if the expected size is strictly positive and the
     *     value is null
  ...
  public static final class InstantAsserter {
    ...
    /**
     * Ensure that the given instant is in the future or at current Instant (considering this method
     * invocation time)
     *
     * @return The current asserter
     * @throws MissingMandatoryValueException if the input value is null
    ...
    /**
     * Ensure that the given instant is in the past or at current Instant (considering this method
     * invocation time)
     *
     * @return The current asserter
     * @throws MissingMandatoryValueException if the input value is null
