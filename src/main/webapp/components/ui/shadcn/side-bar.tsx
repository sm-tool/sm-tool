          ...
          className={cn(
            ...
            variant === 'floating' || variant === 'inset'
              ...
              : `group-data-[collapsible=icon]:w-[--sidebar-width-icon]
                ...
                group-data-[side=right]:border-divider group-data-[side=right]:border-l`,
            className,
          )}
          {...properties}
        >
          <div
            ...
            className='flex h-full w-full flex-col bg-content1 group-data-[variant=floating]:rounded-lg
              ...
              group-data-[variant=floating]:border-content2
...
>(({ className, ...properties }, reference) => (
  <ul
    ...
    className={cn(
      `mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l border-divider px-2.5
      py-0.5`,
      'group-data-[collapsible=icon]:hidden',
      className,
    )}
