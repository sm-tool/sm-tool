INSERT INTO qds_user (email, first_name, id, last_name) VALUES ('student@student.pl','student','fixed-student','student');
-----------------------------------------------------
INSERT INTO qds_scenario (event_duration,event_unit, id, creation_date, end_date, last_modification_date, start_date, context, description, purpose, title) VALUES
(10,'min',nextval('qds_scenario_id_seq'),TIMESTAMP '2024-10-10T20:20:20Z',TIMESTAMP '2024-10-12T20:20:20Z',
 TIMESTAMP '2024-10-10T20:20:20Z', TIMESTAMP '2024-10-10T20:20:20Z', 'KONTEKST','OPIS','CEL','TYTUŁ');
-- Uprawnienia
INSERT INTO qds_permission(id, scenario_id, type, user_id)
VALUES (nextval('qds_permission_id_seq'), 1, 'AUTHOR', 'fixed-student');
--------------------------------------------------------
...
3,'#feffc8','Szablon opisujący szczególny 8-piętrowy budynek', '8-piętrowy budynek');
-- Dodanie attribute-template czyPaliSię                                                             
--                                                                                                      1
INSERT INTO qds_attribute_template (id, object_template_id, name, type, default_value) VALUES (nextval('qds_attribute_template_id_seq'),
1, 'czyPaliSię' , 'BOOL','');
...
--                                                                                                      2
INSERT INTO qds_object_template (id, object_type_id, color, description, title) VALUES (nextval('qds_object_template_id_seq'),
1, '#ff5a5a', 'Szablon opisujący instancjowalną drużynę strażacką', 'Drużyna strażacka');

-- Sprzęt strażacki schemat tworzenia obiektu
-- Template sprzętu                                                                                         
--                                                                                                      3
INSERT INTO qds_object_template (id, object_type_id, color, description, title) VALUES (nextval('qds_object_template_id_seq'),
5, '#ff5a5a', 'Szablon opisujący instancjowalny sprzęt gaśniczy', 'Sprzęt gaśniczy');
...
--                                                                                                      5
INSERT INTO qds_object_template (id, object_type_id, color, description, title) VALUES (nextval('qds_object_template_id_seq'),
6, '#bb69fc', 'Schemat opisujący miejsce pożaru', 'Miejsce pożaru');
...
INSERT INTO qds_scenario_to_object_type (id, object_type_id, scenario_id) VALUES (nextval('qds_scenario_to_object_type_id_seq'), 6,1);
...
--------------------------------------------------------------------------------------Typ asocjacji
--                                                                                                      1
INSERT INTO qds_association_type (first_object_type_id, id, second_object_type_id, description) VALUES (1,nextval('qds_association_type_id_seq'),4,'aktor w pojeździe');
--                                                                                                      2
INSERT INTO qds_association_type (first_object_type_id, id, second_object_type_id, description) VALUES (1,nextval('qds_association_type_id_seq'),6,'aktor na miejscu zdarzenia');
--                                                                                                      3
INSERT INTO qds_association_type (first_object_type_id, id, second_object_type_id, description) VALUES (1,nextval('qds_association_type_id_seq'),3,'aktor w budynku');
--                                                                                                      4
INSERT INTO qds_association_type (first_object_type_id, id, second_object_type_id, description) VALUES (1,nextval('qds_association_type_id_seq'),5,'aktor w posiadaniu sprzętu');
--                                                                                                      5
INSERT INTO qds_association_type (first_object_type_id, id, second_object_type_id, description) VALUES (5,nextval('qds_association_type_id_seq'),6,'sprzęt na miejscu zdarzenia');
--                                                                                                      6
INSERT INTO qds_association_type (first_object_type_id, id, second_object_type_id, description) VALUES (5, nextval('qds_association_type_id_seq'),4,'sprzęt w pojeździe');
...
INSERT INTO qds_branching (branching_time, id, scenario_id, branching_type, description, title, is_correct) VALUES (7,nextval('qds_branching_id_seq'),1,'JOIN',
                                                                                                        'Drużyna 1 pomyślnie ukończyła ewakuację i dołącza do drużyny 2 ','Zakończenie ewakuacji', TRUE);
--- OBIEKTY UŻYWANE PRZEZ THREAD 1
--                                                                                                      1
INSERT INTO qds_object (id,origin_thread_id, object_type_id, scenario_id, template_id, name) VALUES (nextval('qds_object_id_seq'), 0,6,1,5, 'Miejsce pożaru');
--                                                                                                      1
...
--                                                                                                      2
INSERT INTO qds_object (id, origin_thread_id,object_type_id, scenario_id, template_id, name) VALUES (nextval('qds_object_id_seq'),0,3,1,1,'8-piętrowy budynek');
--                                                                                                      2
INSERT INTO qds_thread_to_object (id, object_id, thread_id) VALUES (nextval('qds_thread_to_object_id_seq'),2,1);
-- Dodanie attribute-template czyPaliSię do template 8-piętrowy budynek                                           
--                                                                                                      1
INSERT INTO qds_attribute (attribute_template_id, id, object_id) VALUES (1, nextval('qds_attribute_id_seq'), 2);
...
INSERT INTO qds_attribute_change (attribute_id, event_id, id, value) VALUES (1,1,nextval('qds_attribute_change_id_seq'),'false');
...
--                                                                                                      3
INSERT INTO qds_object (id, origin_thread_id,object_type_id, scenario_id, template_id, name) VALUES (nextval('qds_object_id_seq'), 2,5,1,3,'Sprzęt strażacki');
--                                                                                                      3
...
--                                                                                                      4
INSERT INTO qds_object (id,origin_thread_id, object_type_id, scenario_id, template_id, name) VALUES (nextval('qds_object_id_seq'), 2,1, 1, 2, 'Drużyna strażacka 1');
--                                                                                                      4
INSERT INTO qds_thread_to_object (id, object_id, thread_id) VALUES (nextval('qds_thread_to_object_id_seq'), 4, 2);
--                                                                                                      5
INSERT INTO qds_object (id,origin_thread_id, object_type_id, scenario_id, template_id, name) VALUES (nextval('qds_object_id_seq'), 2,1, 1, 2, 'Drużyna strażacka 2');
--                                                                                                      5
INSERT INTO qds_thread_to_object (id, object_id, thread_id) VALUES (nextval('qds_thread_to_object_id_seq'), 5,2);

--                                                                                                      6
INSERT INTO qds_object (id, origin_thread_id,object_type_id, scenario_id, template_id, name) VALUES (nextval('qds_object_id_seq'), 2,4, 1, 4, 'Pojazd strażacki');
--                                                                                                      6
...
--                                                                                                                      3
INSERT INTO qds_association (association_type_id, id, object1_id, object2_id) VALUES (6,nextval('qds_association_id_seq'),3,6);
--                                                                                                                       4
INSERT INTO qds_association (association_type_id, id, object1_id, object2_id) VALUES (2,nextval('qds_association_id_seq'),4,1);
--                                                                                                                       5
INSERT INTO qds_association (association_type_id, id, object1_id, object2_id) VALUES (2,nextval('qds_association_id_seq'),5,1);
--                                                                                                                      6
INSERT INTO qds_association (association_type_id, id, object1_id, object2_id) VALUES (5,nextval('qds_association_id_seq'),3,1);
--                                                                                                                       7
INSERT INTO qds_association (association_type_id, id, object1_id, object2_id) VALUES (3,nextval('qds_association_id_seq'),4,2);
...
--                                                                                                                                      8
INSERT INTO qds_association_change (association_id, event_id, id, association_operation) VALUES (7,8,nextval('qds_association_change_id_seq'),'INSERT');
--                                                                                                      9
...
--                                                                                                                                                  9
INSERT INTO qds_association_change (association_id, event_id, id, association_operation) VALUES (9, 11, nextval('qds_association_change_id_seq'),'INSERT');
--                                                                                                                      12
...
-- IDLE
INSERT INTO qds_event
(description,title,event_time, id, thread_id, event_type)
VALUES ('','',6,nextval('qds_event_id_seq'),3,'IDLE');

INSERT INTO qds_event
(description,title,event_time, id, thread_id, event_type)
VALUES ('','',6,nextval('qds_event_id_seq'),4,'IDLE');
